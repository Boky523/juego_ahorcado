...
let palabras1 = ["javascript", "java", "phyton", "php", "swift"];
...
function iniciar(event) {
  imagen.src = "/juego_ahorcado/imgM/img0.png";
...
function click_letras(event) {
  ...
  if (acerto == false) {
    cant_errores++;
    const source = `/juego_ahorcado/imgM/img${cant_errores}.png`;
    imagen.src = source;
  }

  if (cant_errores == 4) {
    id("resultado").innerHTML = `
    <div class="alerta_lose" role="alert">
